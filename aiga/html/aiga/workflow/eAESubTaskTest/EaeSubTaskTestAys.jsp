...
//下一环节link信息
var current_linkNo = '<%=WorkflowParam.getWorkflow("eaeSubTaskTestAys").getLinkNo()%>';
//下一环节link信息
var	next_linkId ='';
var next_linkNo = '';
var	next_roleCode = '';
...
function chooseLinkInfo(){
	if(orderResult == 'pass'){
		...
		next_linkId ='<%=WorkflowParam.getWorkflow("eaeSubTaskTestAys").getLinkId()%>';
		next_linkNo = '<%=WorkflowParam.getWorkflow("eaeSubTaskTestAys").getLinkNo()%>';
		next_roleCode = '<%=WorkflowParam.getWorkflow("eaeSubTaskTestAys").getRoleCode()%>';
		stdMark='1';
	}
