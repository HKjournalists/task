...
<%
	...
	String passInfo = "自动回归测试准生产测试完成，进入生产测试";
...
var current_linkNo = '<%=WorkflowParam.getWorkflow("regrTestRunning").getLinkNo()%>';
//下一环节link信息
var	next_linkId ='';
var next_linkNo = '';
var	next_roleCode = '';
...
function resultSave()
{
	//myFrame.window.submitGridStore(); 
	try{
