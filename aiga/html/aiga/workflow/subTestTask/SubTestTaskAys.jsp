...
function chooseLinkInfo(){
	if(orderResult == 'pass'){
		...
		next_linkId ='<%=WorkflowParam.getWorkflow("subTestTaskAys").getLinkId()%>';
		next_linkNo = '<%=WorkflowParam.getWorkflow("subTestTaskAys").getLinkNo()%>';
		next_roleCode = '<%=WorkflowParam.getWorkflow("subTestTaskAys").getRoleCode()%>';
		stdMark='1';
	}
