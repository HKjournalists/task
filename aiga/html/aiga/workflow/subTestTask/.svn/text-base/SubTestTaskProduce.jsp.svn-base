...
<%
	...
	String passInfo = "生产测试通过，测试子任务结束";
			...
			<div class="btmFixed">
				...
				<div class="btmFixed_left" id="putongliucheng">
					<ul>
						...
						<li title="<%=passInfo %>" onmouseover="this.className='hover'" onmouseout="this.className=''" onclick="funSub()">
...
//下一环节link信息
var current_linkNo = '<%=WorkflowParam.getWorkflow("subTestTaskProduce").getLinkNo()%>';
//下一环节link信息
var	next_linkId ='';
var next_linkNo = '';
var	next_roleCode = '';
