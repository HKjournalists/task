...
var current_linkNo = '<%=WorkflowParam.getWorkflow("hwRegrTestProdLinkTest").getLinkNo()%>';
//下一环节link信息
var	next_linkId ='';
var next_linkNo = '';
var	next_roleCode = '';
...
function chooseLinkInfo(){
	if(orderResult == 'pass'){
		next_linkId ='<%=WorkflowParam.getWorkflow("hwRegrTestProVerify").getLinkId()%>';
		next_linkNo = '<%=WorkflowParam.getWorkflow("hwRegrTestProVerify").getLinkNo()%>';
		next_roleCode = '<%=WorkflowParam.getWorkflow("hwRegrTestProVerify").getRoleCode()%>';
		stdMark='3';
	}else if(orderResult == 'regn'){
		next_linkId ='<%=WorkflowParam.getWorkflow("hwRegrTestProdLinkTest").getLinkId()%>';
		next_linkNo = '<%=WorkflowParam.getWorkflow("hwRegrTestProdLinkTest").getLinkNo()%>';
		next_roleCode = '<%=WorkflowParam.getWorkflow("hwRegrTestProdLinkTest").getRoleCode()%>';
		stdMark='1';
	}
