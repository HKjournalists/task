			...
			<div class="btmFixed">
				...
				<div class="btmFixed_left" id="putongliucheng">
					<ul>
						...
						<li title="<%=regnInfo %>" onmouseover="this.className='hover'" onmouseout="this.className=''" onclick="saveQuestion()">
...
//下一环节link信息
//下一环节link信息
var current_linkNo = '<%=WorkflowParam.getWorkflow("testerModify").getLinkNo()%>';
var	next_linkId ='';
var next_linkNo = '';
var	next_roleCode = '';
var next_templateId = '';
...
function chooseLinkInfo(){
	if(orderResult == 'pass'){
		...
		next_linkId ='<%=WorkflowParam.getWorkflow("testerModify").getLinkId()%>';
		next_linkNo = '<%=WorkflowParam.getWorkflow("testerModify").getLinkNo()%>';
		next_roleCode = '<%=WorkflowParam.getWorkflow("testerModify").getRoleCode()%>';
		stdMark='1';
	}
