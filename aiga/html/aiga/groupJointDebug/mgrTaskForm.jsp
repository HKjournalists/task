...
<head>
	...
	<body style="">
		<div>
			<jsp:include page="/aiga/groupJointDebug/mgrTaskFormInfo.jsp">
...
function saveTestPlan()
{
    ...
    if(taskTypeFlag){
		...
		var taskTag = Ext.getCmp('taskTag').getValue();
		var taskPlanBeginCommitTime = Ext.getCmp('taskPlanBeginCommitTime').getValue();
		var taskPlanEndCommitTime = Ext.getCmp('taskPlanEndCommitTime').getValue();
		var devManagerName = Ext.getCmp('devManagerName').getValue();
    	if(taskName==""||taskName==null||taskTag==""||taskTag==null||taskPlanBeginCommitTime==""||taskPlanBeginCommitTime==null||taskPlanEndCommitTime==""||taskPlanEndCommitTime==null||devManagerName==""||devManagerName==null){
    		MaskOver();
