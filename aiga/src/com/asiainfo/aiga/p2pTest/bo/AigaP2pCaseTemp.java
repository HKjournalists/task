...
public class AigaP2pCaseTemp implements java.io.Serializable {
	...
	/** default constructor */
	public AigaP2pCaseTemp() {
	}

	/** minimal constructor */
	public AigaP2pCaseTemp(Integer caseId) {
		this.caseId = caseId;
	}

	/** full constructor */
	public AigaP2pCaseTemp(Integer caseId, String caseName, String caseDesc,
	...
	public boolean equals(Object other) {
		...
		if (other == null)
			return false;
		if (!(other instanceof AigaP2pCaseTemp))
			return false;
		AigaP2pCaseTemp o = (AigaP2pCaseTemp) other;
		try {
