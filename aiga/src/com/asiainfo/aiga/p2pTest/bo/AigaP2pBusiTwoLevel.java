...
/**
 * AigaP2pBusiTwoLevel entity. @author MyEclipse Persistence Tools
 */

public class AigaP2pBusiTwoLevel implements java.io.Serializable {
	...
	/** default constructor */
	public AigaP2pBusiTwoLevel() {
	}

	/** minimal constructor */
	public AigaP2pBusiTwoLevel(Integer p2pBusiId) {
		this.p2pBusiId = p2pBusiId;
	}

	/** full constructor */
	public AigaP2pBusiTwoLevel(Integer p2pBusiId, String busiName,
			Integer busiType, String busiDesc, Integer importantClass,
			String remarks, Integer isInvalid, Integer kernelBusi,
	...
	public Integer getKernelBusi() {
		return this.kernelBusi;
	}

	public void setKernelBusi(Integer kernelBusi) {
		this.kernelBusi = kernelBusi;
	}
