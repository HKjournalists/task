...
public class JsonHelper {
    ...
    public static void main(String[] argv) {
        String strSVNVersion = "RCS: $Id: JsonHelper.java 170963 2012-6-6 Administrator $";
        System.out.println("Current SVN Version:" + strSVNVersion);
        return;
    }
     ...
     */  
     ...
     public static String getJsonStr(Object obj) {   
         String jsonStr = null;   
         //Json配置       
         JsonConfig jsonCfg =BaseAction.jsonConfig;
