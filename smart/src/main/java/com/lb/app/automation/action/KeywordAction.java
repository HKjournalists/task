...
public class KeywordAction {
	...
	public List<AutoKeyword> loadKeywords(String submodule_id) {
		log.info("load keyword sub module id: " + submodule_id);
		return keywordService.load(submodule_id);
	}
	...
	@ExtDirectMethod(value = ExtDirectMethodType.STORE_MODIFY)
	public void  destroyKeywords(List<AutoKeyword> keywords) throws Exception{
