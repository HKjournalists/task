		...
		<script>
			...
			window.onload = function() {
				var settings = {
					...
					// Button settings
					button_image_url : "<%=request.getContextPath()%>/csc/attach/images/XPButtonUploadText_61x22.png",
	...
	<body>
		<div id="pucker1" >
			<table id="pucker_head1" width="100%" height="10" style="padding: 0 0 0 0;margin: 0 0 0 0 ;">
				...
				<tr>
					<td style="width:58;font-family:Arial, 黑体 10pt;" align="center">附件信息:</td>
					<td id="attachList"></td>
					<td>
						<div id="content">
