...
<%
		...
		String selectStaffName = new String(request.getParameter("selectStaffName").getBytes("ISO-8859-1"),"GBK");
...
<html>
  ...
  <body>
	<div id="allocationReqDeal_div" class="div_title">
		<table class="content_title" border="0">
			<tr>
				<td class="content_title_text" >处理人选择<em id="reqInfoTitle" style="font-weight:normal; font-style:normal; padding-left:4px;" ></em></td>
				...
				<td width="45%">
      			 ...
      			 <td style="padding-top: 6px;">
					<ai:stable tableid="staffTable" setname="com.asiainfo.csc.common.web.SETStaffTable"
                         ...
                         ondbclick="" oncellchange="selectedName">
  ...
  function selectStaff()
  {
	  ...
	  if(resTextarea.length == 0&&'<%=needOption%>'=='1') {
  ...
  function selectedName(){
	...
	var curRow = staffTable.getRow();
	var emp_name = staffTable.getValue(staffTable.getRow(),"EMPLOYEE_NAME");
  	$('#selectedStakeholder').text('下一环节处理人:'+emp_name);
  }

  function initStaff()
  {
  	  if('<%=selectStaffName%>'!=''){
  	  	$('#selectedStakeholder').text('下一环节拟定处理人:'+'<%=selectStaffName%>');
  	  }
