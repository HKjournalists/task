...
public class MessageSender {  
	private String host = "mail.asiainfo-linkage.com"; // smtp服务器
	 private String user = "yeteng"; // 用户名
	 private String pwd = "02@ailk"; // 密码
	...
	MessageSender cn = new MessageSender();
	  // 设置发件人地址、收件人地址和邮件标题
	String title = "集团一级系统密码修改";
	String content = "xxx先生/女士，您好：\n\t您获得的验证码为xxx，请以此凭据修改密码，邮件在一分钟内只允许发送一次";
	 ...
	 public String bomcActionSend(String urlString, String param) throws Exception {
		 try {
			 ...
			 e.printStackTrace();
			 throw new Exception("发送邮件出错：" + e.getMessage());
		 }
	 }
	}
