...
public class BOAttachEngine {
  ...
  public static BOAttachBean[] getBeans(DataContainerInterface dc) throws
    ...
    public static BOAttachBean getBean(long _AttId) throws Exception{
            /**new create*/
    String condition = "ATT_ID = :S_ATT_ID";
      Map map = new HashMap();
      map.put("S_ATT_ID",new Long(_AttId));
;
 ...
 public static  BOAttachBean[] getBeans(Criteria sql,int startNum,int endNum,boolean isShowFK) throws Exception{
    ...
    return (BOAttachBean[])getBeans(cols,condition,param,startNum,endNum,isShowFK);
  }
