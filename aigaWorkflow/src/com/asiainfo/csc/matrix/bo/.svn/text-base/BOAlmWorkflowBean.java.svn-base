...
public class BOAlmWorkflowBean extends DataContainer implements DataContainerInterface,IBOAlmWorkflowValue{

  private static String  m_boName = "com.asiainfo.csc.matrix.bo.BOAlmWorkflow";
  ...
  public BOAlmWorkflowBean() throws AIException{
      super(S_TYPE);
  }
 ...
 public void setObjectType(ObjectType  value) throws AIException{
  ...
  public void initConnectPoint(long value){
     this.initProperty(S_ConnectPoint,new Long(value));
  }
  public  void setConnectPoint(long value){
     this.set(S_ConnectPoint,new Long(value));
  }
  public  void setConnectPointNull(){
     this.set(S_ConnectPoint,null);
  }

  public long getConnectPoint(){
        return DataType.getAsLong(this.get(S_ConnectPoint));
  
  }
  public long getConnectPointInitialValue(){
        return DataType.getAsLong(this.getOldObj(S_ConnectPoint));
      }
