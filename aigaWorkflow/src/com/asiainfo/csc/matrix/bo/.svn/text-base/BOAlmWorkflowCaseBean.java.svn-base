...
public class BOAlmWorkflowCaseBean extends DataContainer implements DataContainerInterface,IBOAlmWorkflowCaseValue{

  private static String  m_boName = "com.asiainfo.csc.matrix.bo.BOAlmWorkflowCase";
  ...
  public BOAlmWorkflowCaseBean() throws AIException{
