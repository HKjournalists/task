...
public class BOAlmStakeholderBean extends DataContainer implements DataContainerInterface,IBOAlmStakeholderValue{

  private static String  m_boName = "com.asiainfo.csc.matrix.bo.BOAlmStakeholder";
  ...
  public BOAlmStakeholderBean() throws AIException{
      super(S_TYPE);
  }
